<h2>Basic example</h2>
	<div class="example-block">
		<div class="card">
			<img class="card-img-top img-fluid" src="images/sample/sample-300x250.jpg" alt="Card image cap">
			<div class="card-body">
	...
	<div class="example-block">
		<div class="card">
			...
			<img class="img-fluid" src="images/sample/sample-300x250.jpg" alt="Card image">
			<div class="card-body">
				<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
				<a class="card-link" href=".?<?php echo rand(0, 999); ?>">Card link</a>
				<a class="card-link" href="#">Another link</a>
	...
	<div class="example-block">
		...
		<div class="card">
			...
			<img class="card-img-bottom img-fluid" src="images/sample/sample-300x250.jpg" alt="Card image cap">
		</div>
	</div>
	...
	<div class="example-block">
		<div class="card">
			<img class="card-img img-fluid" src="images/sample/sample-300x250.jpg" alt="Card image">
	...
	<div class="example-block">
		<div class="card-group">
			<div class="card">
				<img class="card-img-top img-fluid" src="images/sample/sample-400x333.jpg" alt="Card image cap">
				<div class="card-body">
					<h4 class="card-title">สุกี้ปารุสก์ คอมไพเลอร์</h4>
					<p class="card-text">สเปซสมุทรสงครามมหาสารคามมงฟอร์ตบารัก อิออนไมถิลี ปัตตานีคันจิ เตลุคูคอมไพเลอร์. เดนมาร์กอูบุนตูโภชนากรมารวิชัยกรีนพีซ.</p>
					<p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
	...
	<div class="example-block">
		<div class="card-columns">
			...
			<div class="card">
				<img class="card-img img-fluid" src="images/sample/sample-400x333.jpg" alt="Card image">
			</div>
			<div class="card card-body text-right">
				<blockquote class="card-blockquote">
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
