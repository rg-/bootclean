...
add_filter( 'of_sanitize_number', 'sanitize_text_field' ); // ADDED
/**
...
function of_sanitize_background_attachment( $value ) {
	...
	return apply_filters( 'of_default_background_attachment', $value );
}
 ...
 * @returns string $value if it is valid
 */
add_filter( 'of_background_size', 'sanitize_text_field' );
...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'bootclean' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'bootclean' ),
		'repeat-y'  => __( 'Repeat Vertically', 'bootclean' ),
		'repeat'    => __( 'Repeat All', 'bootclean' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'bootclean' ),
		'top center'    => __( 'Top Center', 'bootclean' ),
		'top right'     => __( 'Top Right', 'bootclean' ),
		'center left'   => __( 'Middle Left', 'bootclean' ),
		'center center' => __( 'Middle Center', 'bootclean' ),
		'center right'  => __( 'Middle Right', 'bootclean' ),
		'bottom left'   => __( 'Bottom Left', 'bootclean' ),
		'bottom center' => __( 'Bottom Center', 'bootclean' ),
		'bottom right'  => __( 'Bottom Right', 'bootclean')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'bootclean' ),
		'fixed'  => __( 'Fixed in Place', 'bootclean')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'bootclean' ),
		'italic'      => __( 'Italic', 'bootclean' ),
		'bold'        => __( 'Bold', 'bootclean' ),
		'bold italic' => __( 'Bold Italic', 'bootclean' )
		);
