...
/**
 * 
 * Filtered enable/disable using 'WPBC_cleaner__comments_disable'
 *
...
if ( ! class_exists( 'Remove_Comments_Absolute' ) ) {
	...
	if( apply_filters('WPBC_cleaner__comments_disable','__return_true') ){
		add_action( 'after_setup_theme', array( 'Remove_Comments_Absolute', 'get_object' ) );
	...
	class Remove_Comments_Absolute {
		...
		public function comments_template() {
			return get_template_directory() . '/template-parts/comments-none.php';
...
/*
	The old basic way, dont remove, just disabled by default
*/
if( apply_filters('WPBC_cleaner__comments_disable_old','__return_false') ){
