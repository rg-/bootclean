...
function WPBC_is_woo_product_advanced(){
	$woo_enable_product_advanced = apply_filters('wpbc/filter/woocommerce/woo_product_advanced/enabled',0);
	return $woo_enable_product_advanced;
}



add_filter('wpbc/filter/woocommerce/woo_product_advanced/fields', 'WPBC_woo_acf_product_header',10,1);
function WPBC_woo_acf_product_header($fields){
	$fields[] = array(
...
add_filter('wpbc/filter/woocommerce/woo_product_advanced/fields', 'WPBC_woo_acf_product_preview',20,1);
...
if( WPBC_is_woo_product_advanced() && function_exists('acf_add_local_field_group') ) {

	$fields = array();

	$fields = apply_filters('wpbc/filter/woocommerce/woo_product_advanced/fields', $fields);
...
function WPBC_woo_product_pageheader($params){
	...
	if( is_product() && WPBC_woo_if_product_has_header() ){
		$header_type = WPBC_woo_if_product_has_header();
		/* 
