...
if( ! class_exists('acf_field_true_false_advanced') ) :

class acf_field_true_false_advanced extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// vars
		$this->name = 'true_false_advanced';
		$this->label = __('True / False Advanced','bootclean');
	...
	*/
	...
	function render_field( $field ) {
		...
		if( $field['ui'] ) {
			...
			$switch .= '<div class="acf-switch' . ($active ? ' -on' : '') . '' . ($disabled ? ' disabled' : '') . '">';
...
<div class="acf-true-false">
	...
	<label class="<?php echo ($disabled ? ' disabled' : ''); ?>">
...
// initialize
acf_register_field_type( 'acf_field_true_false_advanced' );
