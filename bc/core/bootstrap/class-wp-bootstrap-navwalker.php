...
/*
	Bootstrap nav-item and nav-link fix
*/
...
add_filter('nav_menu_link_attributes', function($atts, $item, $args, $depth){  
	if ( !empty($atts['class'])  && false === strpos($atts['class'], 'nav-link') ) {
	    $atts['class'] .= ' nav-link';
	}	
	return $atts;
}, 9999, 4);
...
/*
	...
	HOWTO - Add dropdown hover into navbar walker by code

add_filter('nav_menu_link_attributes', function($atts, $item, $args, $depth){ 
	if ( isset( $args->has_children ) && $args->has_children && 0 === $depth && $args->depth > 1 ) {
		$atts['data-hover'] = 'dropdown';
		$atts['hover-respond'] = 'md';
	}  
	return $atts;
}, 10, 4); 

add_filter( 'nav_menu_submenu_attrs', function($submenu_attrs, $args, $depth){
	if ( isset( $args->has_children ) && $args->has_children && 0 === $depth && $args->depth > 1 ) {
		$submenu_attrs['data-animated-respond'] = "lg";
	} 
	return $submenu_attrs;
}, 10, 3 );
