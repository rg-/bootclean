...
class TokkoDivisions
{
   ...
   var $AJAX_URL_STATE = "http://tokkobroker.com/api/v1/location/?format=json&lang=es_ar&limit=100&state=";
   var $AJAX_URL_DIVISION = "http://tokkobroker.com/api/v1/location/?format=json&lang=es_ar&limit=100&parent_division=";
   var $divisions = null;
   var $select_box_id = '';
