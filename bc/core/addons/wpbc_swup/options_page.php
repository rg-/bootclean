...
function WPBC_swup_settings_fields(){
	...
	$fields[] =  WPBC_acf_make_subtitle_field(
		array( 
			...
			'label' => '', 
			'message' => '<svg xmlns="http://www.w3.org/2000/svg" width="400" height="173" viewBox="0 0 996 429">
  <g fill="none">
...
</svg><p>Complete, flexible, extensible and easy to use page transition library for your website.</p>', 
		)
	); 
