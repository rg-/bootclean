...
<div class="ui_accordion-item card">
  ...
  <div class="ui_accordion-header card-header p-0" id="<?php echo $args['heading_id']; ?>">
    <h2 class="mb-0">
      <button class="<?php echo $toggle_class; ?>" type="button" data-toggle="collapse" data-target="#<?php echo $args['collapse_id']; ?>" aria-expanded="<?php echo $toggle_expanded; ?>" aria-controls="<?php echo $collapse_id; ?>">
        <?php echo $args['title']; ?> <span class="btn-feedback-icon collapse-icon rotate gpr-1"><?php echo $toggle_icon; ?></span>
      </button>
    </h2>
  </div>
